...
| P2P | Fixed `kind` port mappings | Outbound peers and advancing heads on both live pairs; mixed-protocol public NLB remains unqualified | Advertised/reachable TCP+UDP parity, inbound traffic evidence, and DDoS posture |
