...
| `terraform` | `/terraform/environments/durable` | `*.tf`, `.terraform.lock.hcl` | Wednesday | 2 |
...
Thirteen open pull requests is the declared ceiling, weekly, staggered across five
